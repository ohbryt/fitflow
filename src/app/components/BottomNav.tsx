...
const navItems = [
  ...
  { href: "/workout", label: "기록", icon: "play" },
...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-4 left-4 right-4 z-50">
      <div className="max-w-lg mx-auto glass-strong rounded-2xl shadow-2xl shadow-black/40">
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                <span className={`relative z-10 text-[10px] font-semibold ${isActive ? "text-primary" : ""}`}>{item.label}</span>
              </Link>
            );
          })}
        </div>
